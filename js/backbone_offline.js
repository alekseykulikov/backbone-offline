...
(function() {
  ...
  (function(global, _, Backbone) {
    global.Offline = {
      VERSION: '0.4.2',
      backboneIsPre_0_9_10: function() {
        var backboneVersionNumbers;
        backboneVersionNumbers = _.map(Backbone.VERSION.split("."), parseFloat);
        return !(backboneVersionNumbers[0] > 0 || backboneVersionNumbers[1] > 9) && backboneVersionNumbers[2] < 10;
      },
      localSync: function(method, model, options, store) {
        ...
        if (resp) {
          if (this.backboneIsPre_0_9_10()) {
            return options.success((_ref = resp.attributes) != null ? _ref : resp);
          } else {
            return options.success(model, (_ref1 = resp.attributes) != null ? _ref1 : resp, options);
          }
        } else {
