...
(function() {
  define(['backbone', 'underscore', 'Lawnchair','lawnchair.indexed-db', 'lawnchair.webkit-sqlite', 'lawnchair.dom', 'vent'],function(Backbone, _, Lawnchair, LawnchairIndexDb, LawnchairWebkitSqlite, LawnchairDom, vent) {
